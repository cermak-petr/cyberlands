...
local function register_meadow_weed(decoration, fill)
    if not fill then fill = 0.01 end
    minetest.register_decoration({
        deco_type = "simple",
        place_on = "scifi_nodes:grassblk",
        sidelen = 8,
        fill_ratio = 0.02,
        biomes = {"Alien Meadows"},
        y_min = -31000,
        y_max = 31000,
