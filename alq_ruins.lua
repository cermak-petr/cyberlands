...
--[[minetest.register_decoration({
    ...
    schematic = "schems/alq_building_5.mts",
    place_offset_y = 0,
    rotation = "random",
})]]--
...
minetest.register_decoration({
    ...
    y_max = 31000,
    flags = "force_placement, place_center_x, place_center_z",
    schematic = "schems/alq_building_orig_big.mts",
    place_offset_y = 0,
    rotation = "random",
})
...
minetest.register_decoration({
    ...
    y_max = 31000,
    flags = "force_placement, place_center_x, place_center_z",
    schematic = "schems/alq_building_3.mts",
    place_offset_y = 0,
    rotation = "random",
})
...
minetest.register_decoration({
    ...
    y_max = 31000,
    flags = "force_placement, place_center_x, place_center_z",
    schematic = "schems/alq_building_2.mts",
    place_offset_y = 0,
    rotation = "random",
})
